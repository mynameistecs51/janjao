...
--
-- Host: localhost
-- Generation Time: Jun 26, 2017 at 07:09 PM
...
-- Functions
--
CREATE DEFINER=`root`@`%` FUNCTION `fn_gen_sn` (`param_sncode` VARCHAR(10), `param_refcode` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET utf8 COLLATE utf8_unicode_ci MODIFIES SQL DATA
BEGIN
...
(0, 'TSF', '1706', 1, 'TSF1706', '2017-06-22 01:00:51'),
(0, 'AAA', '1706', 4, 'AAA1701', '2017-06-22 01:05:48');
...
INSERT INTO `ts_booked` (`bookedID`, `bookedCode`, `idcardno`, `idcardnoPath`, `titleName`, `firstName`, `middleName`, `lastName`, `birthdate`, `address`, `district`, `province`, `country`, `postcode`, `mobile`, `email`, `bookedDate`, `checkInAppointDate`, `checkOutAppointDate`, `is_breakfast`, `bookedType`, `cashPledge`, `cashPledgePath`, `comment`, `status`, `createDT`, `createBY`, `updateDT`, `updateBY`) VALUES
(31, '1', 2147483647, '1111111111111.png', 'male', '', '', '', NULL, '', NULL, NULL, '', '', '11111111111', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 'DAY', 0.00, '', '', 'ON', '2017-06-26 23:38:10', 'admin', '2017-06-26 23:38:10', 'admin'),
(32, '1', 2147483647, '1111111111111.png', 'male', '', '', '', NULL, '', NULL, NULL, '', '', '11111111111', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 'DAY', 0.00, '', '', 'ON', '2017-06-26 23:39:02', 'admin', '2017-06-26 23:39:02', 'admin');
...
(33, 32, 210, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 'BOOKED', '2017-06-26 23:39:02', 'admin', '2017-06-26 23:39:02', 'admin'),
(34, 32, 212, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 'BOOKED', '2017-06-26 23:39:02', 'admin', '2017-06-26 23:39:02', 'admin'),
(35, 32, 214, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 'BOOKED', '2017-06-26 23:39:02', 'admin', '2017-06-26 23:39:02', 'admin');
...
INSERT INTO `ts_booked_room_log` (`logroomdateID`, `bookedroomID`, `roomID`, `logDate`, `comment`, `status`, `createDT`, `createBY`, `updateDT`, `updateBY`) VALUES
(35, 33, 210, '2017-06-26 23:39:02', '', 'BOOKED', '2017-06-26 23:39:02', 'admin', '2017-06-26 23:39:02', 'admin'),
(36, 34, 212, '2017-06-26 23:39:02', '', 'BOOKED', '2017-06-26 23:39:02', 'admin', '2017-06-26 23:39:02', 'admin'),
(37, 35, 214, '2017-06-26 23:39:02', '', 'BOOKED', '2017-06-26 23:39:02', 'admin', '2017-06-26 23:39:02', 'admin');
...
--
ALTER TABLE `tc_menu_config`
  MODIFY `menuConfigID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
-- AUTO_INCREMENT for table `tm_menu`
--
ALTER TABLE `tm_menu`
  MODIFY `MenuID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `tm_roomtype`
  MODIFY `roomtypeID` int(10) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `ts_booked`
  MODIFY `bookedID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT for table `ts_booked_room`
--
ALTER TABLE `ts_booked_room`
  MODIFY `bookedroomID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT for table `ts_booked_room_log`
--
ALTER TABLE `ts_booked_room_log`
  MODIFY `logroomdateID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT for table `ts_cash_dtl`
--
ALTER TABLE `ts_cash_dtl`
  MODIFY `cashdtlID` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ts_cash_hdr`
--
ALTER TABLE `ts_cash_hdr`
  MODIFY `cashhdrID` bigint(20) NOT NULL AUTO_INCREMENT;
--
