...
class Checkout extends CI_Controller {
	...
	public function index(){
		...
		$this->packfunction->packView($this->data,"checkout/CheckoutList");
	}
	...
	public function CheckinForm()
	{
		...
		$this->data['getlist']=$this->Mdl_user->getList($this->data['keyword']);
		$this->packfunction->packView($this->data,"checkout/CheckoutForm");
	}
	...
	public function search(){
		...
		$this->packfunction->packView($this->data,"user/CheckoutList");
	}
