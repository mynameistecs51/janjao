...
--
-- Host: localhost
-- Generation Time: Jun 21, 2017 at 05:37 PM
...
-- Functions
--
CREATE DEFINER=`root`@`%` FUNCTION `fn_gen_sn` (`param_sncode` VARCHAR(20) CHARSET utf8, `param_refcode` VARCHAR(20) CHARSET utf8) RETURNS VARCHAR(20) CHARSET utf8 MODIFIES SQL DATA
BEGIN
...
(26, 1, 17, 'ON', 'ON', 'ON', 'ON', 'ON', 'ON', 'ON', '2017-06-14 21:12:21', ''),
(27, 1, 17, 'ON', 'ON', 'ON', 'ON', 'ON', 'ON', 'ON', '2017-06-14 21:12:21', ''),
(28, 1, 17, 'ON', 'ON', 'ON', 'ON', 'ON', 'ON', 'ON', '2017-06-14 21:12:21', '');
...
(26, 'รายงานยอดเช่าห้อง', NULL, 5, 'report/booked', NULL, 2, 14, 'ON', '2017-06-14 21:07:29', NULL),
(27, 'รายงานยอดเช่าห้อง', NULL, 5, 'report/revenue', NULL, 2, 15, 'ON', '2017-06-14 21:07:33', NULL),
(28, 'สินค้าบริการ', NULL, 5, 'report/service', NULL, 2, 16, 'ON', '2017-06-14 21:09:45', NULL),
(29, 'ทรัพสินเสียหาย', NULL, 5, 'report/service', NULL, 2, 17, 'ON', '2017-06-14 21:09:50', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tm_room`
--
...
--
-- Dumping data for table `tm_room`
--

INSERT INTO `tm_room` (`roomID`, `roomtypeID`, `floor`, `roomCODE`, `transaction`, `comment`, `status`, `createDT`, `createBY`, `updateDT`, `updateBY`) VALUES
(1, 1, '2', '202', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(2, 1, '2', '204', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(3, 1, '2', '206', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(4, 1, '2', '208', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(5, 1, '2', '210', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(6, 1, '2', '212', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(7, 1, '2', '214', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(8, 1, '2', '216', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(9, 1, '2', '218', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(10, 1, '2', '220', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(11, 1, '2', '201', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(12, 1, '2', '203', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(13, 1, '2', '205', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(14, 1, '2', '207', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(15, 1, '2', '209', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(16, 1, '2', '211', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(17, 1, '2', '213', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(18, 1, '2', '215', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(19, 1, '2', '217', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(20, 1, '2', '219', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(21, 1, '3', '302', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(22, 1, '3', '304', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(23, 1, '3', '306', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(24, 1, '3', '308', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(25, 1, '3', '310', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(26, 1, '3', '312', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(27, 1, '3', '314', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(28, 1, '3', '316', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(29, 1, '3', '318', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(30, 1, '3', '320', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(31, 1, '3', '301', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(32, 1, '3', '303', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(33, 1, '3', '305', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(34, 1, '3', '307', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(35, 1, '3', '309', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(36, 1, '3', '311', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(37, 1, '3', '313', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(38, 1, '3', '315', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(39, 1, '3', '317', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(40, 1, '3', '319', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(41, 1, '4', '402', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(42, 1, '4', '404', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(43, 1, '4', '406', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(44, 1, '4', '408', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(45, 1, '4', '410', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(46, 1, '4', '412', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(47, 1, '4', '414', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(48, 1, '4', '416', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(49, 1, '4', '418', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(50, 1, '4', '420', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(51, 1, '4', '401', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(52, 1, '4', '403', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(53, 1, '4', '405', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(54, 1, '4', '407', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(55, 1, '4', '409', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(56, 1, '4', '411', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(57, 1, '4', '413', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(58, 1, '4', '415', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(59, 1, '4', '417', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL),
(60, 1, '4', '419', 'EMPTY', NULL, 'ON', '2560-06-20 22:06:59', 'admin', NULL, NULL);
...
(13, '', '', '', 's', '', '', '', '', 212, '', '', '', '', '', NULL, NULL, 0, 'ON', '2017-06-13 00:23:05', 'admin', '2017-06-13 00:23:05', 'admin');
...
CREATE TABLE `tsc_gen` (
  ...
  `sncode` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'อักษรขึ้นต้นของ Transection / เลขที่เอกสาร',
  `day_number` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รหัสแผนก',
  `last_number` varchar(10) DEFAULT NULL COMMENT 'Number ล่าสุด',
  `ref_code` varchar(20) DEFAULT NULL COMMENT 'วันที่สร้าง',
...
INSERT INTO `ts_country` (`countryID`, `countryName`, `status`, `updateDT`, `updateBY`) VALUES
...
ALTER TABLE `ts_country`
  ADD PRIMARY KEY (`countryID`,`countryName`);
...
--
ALTER TABLE `tc_menu_config`
  MODIFY `menuConfigID` int(11) NOT NULL AUTO_INCREMENT COMMENT '????????????????', AUTO_INCREMENT=29;
--
...
--
-- AUTO_INCREMENT for table `tm_room`
--
ALTER TABLE `tm_room`
  MODIFY `roomID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
--
...
--
ALTER TABLE `tm_usergroup`
  MODIFY `usergroupID` int(11) NOT NULL AUTO_INCREMENT COMMENT '??????????????', AUTO_INCREMENT=4;
